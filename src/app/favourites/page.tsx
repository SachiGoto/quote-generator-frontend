  ...
  useEffect(() => {
    ...
    const checkOverflow = () => {
      ...
      filteredQuotes?.forEach((quote, index) => {
        ...
        console.log("element has ellipses? ", element?.offsetHeight, element?.scrollHeight)
        if (element?.offsetHeight !== element?.scrollHeight) {
          newSet.add(quote.quoteId);
          console.log("this text has ellipses" , element)
          setOverflowQuotes(newSet);
        }
      //  console.log("overFlowQuotes are ", overflowQuotes)
      });
             ...
             return (
               ...
               >
                 ...
                 <Text
                   ...
                   pb={overflowQuotes.has(quote.quoteId) && !isExpanded? "60px":0}
